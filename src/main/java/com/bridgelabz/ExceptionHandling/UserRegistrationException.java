	...
	public boolean firstName(String fName){
		...
		try {
			if (check){
				...
				throw new CustomException("Please Enter a Valid First name with Only \"One Starting Capital\" latter");
			}
	...
	public boolean lastName(String lName){
		...
		try {
			if (check){
				...
				throw new CustomException("Please Enter a Valid Last name with Only \"One Starting Capital\" latter");
			}
		}catch (CustomException ce){
			System.out.printf(ce.getMessage());
		}
	...
	public boolean eMail(String eMail){
		...
		try {
			if (check){
				...
				throw new CustomException("Please Enter a Valid Email with Only \"example.abc@bl.co.in\" latter");
			}
		}catch (CustomException ce){
			System.out.printf(ce.getMessage());
		}
	...
	public boolean mobileNum(String mNum){
		...
		try {
			if (check){
				...
				throw new CustomException("Please Enter a Valid Mobile Num ex:- 90 9533182605");
			}
		}catch (CustomException ce){
			System.out.printf(ce.getMessage());
		}
	...
	public boolean pass1(String pass){
		...
		try {
			if (check){
				...
				throw new CustomException("Please Enter a Valid password, it should have minimum 8 characters");
			}
		}catch (CustomException ce){
			System.out.printf(ce.getMessage());
		}
	...
	public boolean pass2(String pass){
		...
		try {
			if (check){
				...
				throw new CustomException("Please Enter a Valid password, it should have minimum 8 characters with 1 upper case");
			}
		}catch (CustomException ce){
			System.out.printf(ce.getMessage());
		}
	...
	public boolean pass3(String pass){
		...
		try {
			if (check){
				...
				throw new CustomException("Please Enter a Valid password, it should have minimum 8 characters with, 1 upper case and 1 Numeric");
			}
		}catch (CustomException ce){
			System.out.printf(ce.getMessage());
		}
	...
	public boolean pass4(String pass){
		...
		try {
			if (check){
				...
				throw new CustomException("Please Enter a Valid password, it should have minimum 8 characters with, 1 upper case, 1 Numeric and 1 Special Char");
			}
		}catch (CustomException ce){
			System.out.printf(ce.getMessage());
		}
